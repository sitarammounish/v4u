...
const About = () => {
  return (
    <div style={{ marginTop: "50px", color: "#273b52" }}>
      {/* this section will return about us page banner image */}
      <Container>
        <Row className="mt-4">
          <Col md={12}>
            <Carousel>
      ...
      <hr />
      <Container>
        {/* this container shows the buffet cusine and live counter information */}
        <Row className="mt-4">
          <Col md={12}>
            ...
            <Carousel>
              <Carousel.Item>
                ...
                />
                <Carousel.Caption>
                    {/* First slider - indian and south indian carousel code */}
              ...
              <Carousel.Item>
                ...
                />
                <Carousel.Caption>
                    {/* second slider - dosa live counter carousel code */}
              ...
              <Carousel.Item>
                ...
                />
                <Carousel.Caption>
                    {/* third slider rajthani thali carousel code */}
      ...
      <hr />
      <Container>
        {/* last container - our commitement to excellence*/}
        <Row className="mt-4">
          <Col md={12}>
